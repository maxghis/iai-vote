<div class="container-fluid">
	...
	<form action="" id="manage-matricule">
		...
		<div class="form-group">
			...
			<input type="text" name="matricule" id="<?= isset($matricule) ? $matricule->id : '' ?>" class="form-control" value="<?= isset($matricule) ? $matricule->matricule : '' ?>" required>
		</div>
...
<script>
	$('#manage-matricule').submit(function(e){
		...
		start_load()
		$.ajax({
            url:'<?= route("matricule_manager", "save") ?>',
			method:'POST',
			data:$(this).serialize(),
