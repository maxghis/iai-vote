...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('assetsn/font-awesome/css/all.min.css')}}">


<!-- Vendor CSS Files -->
<link href="{{ asset('assetsn/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
...
<script src="{{ asset('assetsn/vendor/bootstrap-datepicker/js/bootstrap-datepicker.min.js')}}"></script>
  <script type="text/javascript" src="{{ asset('assetsn/font-awesome/js/all.min.js')}}"></script>
<script type="text/javascript" src="{{ asset('assetsn/js/jquery-te-1.4.0.min.js')}}" charset="utf-8"></script>
